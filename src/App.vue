<template>
  <!-- Progress Bar -->
  <progress-bar v-if="onboardingStep > 0"></progress-bar>
  ...
  <svg
    ...
    class="absolute top-12 -right-8 h-5 md:right-12 md:h-8"
  >
    <g id="svgexport-1" transform="translate(-3.18 -4.61)">
      <path
        ...
        :fill="onboardingStep === 5 ? '#ffffff' : '#394ced'"
      />
      <path
        id="Path_563"
        data-name="Path 563"
  ...
  >
    ...
    <profile-picture
      ...
      :userFirstName="userFirstName"
    ></profile-picture>
    <browser-permissions v-if="onboardingStep === 18"></browser-permissions>
    <completed-onboarding
      v-if="onboardingStep === 19"
      :userFirstName="userFirstName"
    ></completed-onboarding>
    ...
    <button
      ...
      class="button mt-10 md:mt-16 absolute bottom-28"
      @click="nextStep"
    >
      Let's get started!
    </button>
    <button
      v-else-if="onboardingStep === 18"
      class="button mt-10 md:mt-16 absolute bottom-24"
    >
  ...
  <img
    ...
    alt=""
    v-if="onboardingStep === 5"
    class="absolute right-10 top-48"
  />
</template>
...
import FirstName from "./components/1FirstName.vue";
import LastName from "./components/2LastName.vue";
import AgeGroup from "./components/3AgeGroup.vue";
import GenderStep from "./components/4GenderStep.vue";
import AimeInfo from "./components/5AIMEInfo.vue";
import GoalsStep from "./components/6GoalsStep.vue";
import InterestsStep from "./components/7InterestsStep.vue";
...
import BrowserPermissions from "./components/18BrowserPermissions.vue";
import CompletedOnboarding from "./components/19CompletedOnboarding.vue";
